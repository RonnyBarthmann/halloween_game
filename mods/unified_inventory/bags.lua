...
unified_inventory.register_page("bags", {
	get_formspec = function(player)
		...
		formspec = formspec.."label[0,0;"..F(S("Taschen")).."]"
		formspec = formspec.."button[0,2;2,0.5;bag1;"..F(S("Tasche @1", 1)).."]"
		formspec = formspec.."button[2,2;2,0.5;bag2;"..F(S("Tasche @1", 2)).."]"
		formspec = formspec.."button[4,2;2,0.5;bag3;"..F(S("Tasche @1", 3)).."]"
		formspec = formspec.."button[6,2;2,0.5;bag4;"..F(S("Tasche @1", 4)).."]"
...
minetest.register_tool("unified_inventory:bag", {
	description = S("Rucksack"),
	inventory_image = "ui_bags_icon.png",
	groups = {bagslots=24},
})

minetest.register_craft({
	output = "unified_inventory:bag",
	recipe = {
		{"mobs:string", "mobs:leather", "mobs:string"},
		{"mobs:leather", "default:diamond", "mobs:leather"},
		{"mobs:string", "mobs:leather", "mobs:string"}
	}
})
