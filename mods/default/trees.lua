...
local function is_snow_nearby(pos)
	return minetest.find_node_near(pos, 1, {"group:snowy_grass"})
end
...
function default.grow_sapling(pos)
	...
	if node.name == "default:sapling" then
		minetest.log("action", "Ein Setzling wächst zu einem Baum heran bei "..
	...
	elseif node.name == "default:junglesapling" then
		minetest.log("action", "Ein Tropensetzling wächst zu einem Baum heran bei "..
			minetest.pos_to_string(pos))
		if mg_name == "v6" then
	...
	elseif node.name == "default:pine_sapling" then
		minetest.log("action", "Ein Fichtensetzling wächst zu einem Baum heran bei "..
			minetest.pos_to_string(pos))
	...
	elseif node.name == "default:acacia_sapling" then
		minetest.log("action", "Ein Akaziensetzling wächst zu einem Baum heran bei "..
			minetest.pos_to_string(pos))
		default.grow_new_acacia_tree(pos)
	elseif node.name == "default:aspen_sapling" then
		minetest.log("action", "Ein Birkensetzling wächst zu einem Baum heran bei "..
			minetest.pos_to_string(pos))
		default.grow_new_aspen_tree(pos)
	elseif node.name == "default:bush_sapling" then
		minetest.log("action", "Ein Buschsetzling wächst in einen Busch bei "..
			minetest.pos_to_string(pos))
		default.grow_bush(pos)
	elseif node.name == "default:acacia_bush_sapling" then
		minetest.log("action", "Ein Akazienbuschsetzling wächst in einen Busch bei "..
			minetest.pos_to_string(pos))
		default.grow_acacia_bush(pos)
	elseif node.name == "default:pine_bush_sapling" then
		minetest.log("action", "Ein Nadelbuschsetzling wächst in einen Busch bei "..
			minetest.pos_to_string(pos))
...
function default.sapling_on_place(itemstack, placer, pointed_thing,
	...
	if minetest.is_area_protected(
		...
		minetest.chat_send_player(player_name,
			itemstack:get_definition().description .. " wird ein fremdes Schutzgebiet beim Wuchs durchdringen.")
		return itemstack
	end
