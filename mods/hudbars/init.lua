...
-- table which records which HUD bar slots have been â€œregisteredâ€ so far; used for automatic positioning
hb.registered_slots = {}
...
function hb.register_hudbar(identifier, text_color, label, textures, default_start_value, default_start_max, default_start_hidden, format_string)
	...
	hudtable.add_all = function(player, hudtable, start_value, start_max, start_hidden)
		...
		local main_error_text =
			"[hudbars] Schlechte Anfangswerte der HUD-Balkenkennung "..tostring(identifier).." von "..name..". "
...
function hb.change_hudbar(player, identifier, new_value, new_max_value, new_icon, new_bgicon, new_bar, new_label, new_text_color)
	...
	local main_error_text =
		"[hudbars] Fehler! hb.change_hudbar, Kennung: "..tostring(identifier)..", von "..name..". "
...
if minetest.settings:get_bool("enable_damage") or hb.settings.forceload_default_hudbars then
	hb.register_hudbar("health", 0xFFFFFF, S("Leben"), { bar = "hudbars_bar_health.png", icon = "hudbars_icon_health.png", bgicon = "hudbars_bgicon_health.png" }, 20, 20, false)
	hb.register_hudbar("breath", 0xFFFFFF, S("Atem"), { bar = "hudbars_bar_breath.png", icon = "hudbars_icon_breath.png", bgicon = "hudbars_bgicon_breath.png" }, 10, 10, true)
end
